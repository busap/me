...
export const ImagesGroup = () => {
    ...
    return (
        <motion.div
            ...
            transition={{ duration: 0.5, ease: 'linear', delay: 1.3 }}
            className="relative z-10 w-[150px] h-[150px] sm:w-[225px] sm:h-[225px] rounded-full shadow-xl border-2 border-slate-500"
        >
